        ...
        {items.map((item, index) => (
          <div className="relative" key={index}>
            ...
            <div className="absolute space-y-3 text-left left-[10%] lg:space-y-7 top-[30%] ">
              ...
              <button onClick={() =>navigate(`/products/category/${item.link}`)} className="py-2 px-10 font-semibold bg-[#2206fb] rounded-[24px] text-[#fff] hover:bg-[#272726] transition-all duration-300 ease-in ">
                Shop now
              </button>
            </div>
          </div>
